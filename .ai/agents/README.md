...
4. consultar `Validações manuais e externas` em `docs/guia-operacional.md` e as melhorias documentais da área quando a tarefa envolver priorização ou planejamento;
