...
7. ler `docs/developer/architecture.md`, `docs/developer/source-audit.md` e `docs/developer/class-map.md` quando a tarefa envolver análise ampla ou refatoração;
