...
- o manifesto MSIX/WAP foi realinhado com a versao central
  `src/BuildVersion.props` (`7.1.3.14`).
...
- o pacote local sem publicacao no GitHub gerou:
  `artifacts\release\MPV.NET-Media-Player-v7.1.3.14-portable-x64\`,
  `artifacts\release\MPV.NET-Media-Player-v7.1.3.14-portable-x64.zip` e
  `artifacts\release\MPV.NET-Media-Player-v7.1.3.14-setup-x64.exe`;
