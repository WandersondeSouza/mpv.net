...
var tests = new (string Name, bool Result)[]
{
    ...
    ("Brazilian Portuguese uses BRL donation link", AppClass.GetStripeDonationUrl("portuguese-brazil") == "https://donate.stripe.com/bJedRa0Fd21G4hg5OneIw00"),
    ("Non-Brazilian language uses USD donation link", AppClass.GetStripeDonationUrl("english") == "https://donate.stripe.com/8x2fZi1Jh49O3dcdgPeIw01"),
    ("Portugal Portuguese uses USD donation link", AppClass.GetStripeDonationUrl("portuguese-portugal") == "https://donate.stripe.com/8x2fZi1Jh49O3dcdgPeIw01"),
