...
var tests = new (string Name, bool Result)[]
{
    ...
    ("Donation portal uses Brazilian Portuguese culture", AppClass.GetDonationUrl("portuguese-brazil") == "https://www.gestaodesistemas.com.br/doar/mpvnet?language=pt-BR&source=desktop-app"),
    ("Donation portal uses the selected language", AppClass.GetDonationUrl("portuguese-portugal") == "https://www.gestaodesistemas.com.br/doar/mpvnet?language=pt-PT&source=desktop-app"),
    ("Donation portal falls back to English", AppClass.GetDonationUrl("unknown") == "https://www.gestaodesistemas.com.br/doar/mpvnet?language=en&source=desktop-app"),
