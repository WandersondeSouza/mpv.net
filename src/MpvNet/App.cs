...
public class AppClass
{
    ...
    public void EnsureInitialSelectMenuConf()
    {
        ...
        if (File.Exists(path))
        {
            ...
            if (content.StartsWith("# mpv.net autogenerated select.lua menu", StringComparison.Ordinal) &&
                content.Contains($"culture={culture}", StringComparison.OrdinalIgnoreCase))
                return;
    ...
    string BuildSelectMenuConf(string culture)
    {
        ...
        sb.AppendLine($"# mpv.net autogenerated select.lua menu; culture={culture}; version=1");
        ...
        AddMenuItem("Support", "script-binding select/open-chat");
