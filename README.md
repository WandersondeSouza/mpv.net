...
Os scripts antigos `build-store-package.ps1`, `build-store-package-auto.ps1` e `find-store-certificate.ps1` ficaram apenas como compatibilidade interna; prefira `publish-store-package.ps1`.
